 ...
 * $Log: dicCgiShowRequestRegistrationForm.c,v $
...
main (int argc, char **argv)
{
   ...
   printf ("          <td></td>\n");
   printf ("          <td align='right'>%s:</td>\n",
           DicGetWebUserInterfaceMessage (dicUserNameConfirmationMessage, dicLanguage));
   printf ("          <td></td>\n");
   printf ("          <td align='left'><input type='text' maxlength='%i' size='45' name='dicUserNameConfirmation'></td>\n", DIC_USERNAME_MAX_LENGTH);
   printf ("          <td></td>\n");
   printf ("        </tr>\n");
   printf ("        <tr>\n");
   printf ("          <td></td>\n");
   ...
   printf ("          <td></td>\n");
   printf ("          <td align='right'>%s:</td>\n",
           DicGetWebUserInterfaceMessage (dicEmailConfirmationMessage, dicLanguage));
   printf ("          <td></td>\n");
   printf ("          <td align='left'><input type='text' maxlength='%i' size='45' name='dicEmailConfirmation'></td>\n", DIC_EMAIL_MAX_LENGTH);
   printf ("          <td></td>\n");
   printf ("        </tr>\n");
   printf ("        <tr>\n");
   printf ("          <td></td>\n");
   ...
   printf ("          <td align='center'><input type='submit' value='%s'></td>\n",
           DicGetWebUserInterfaceMessage (dicRegisterButtonMessage, dicLanguage));
   printf ("          <td></td>\n");
   printf ("        </tr>\n");
   printf ("      </form>\n");
   printf ("    </table>\n");
   ...
   {
      printf ("          <td align='left'><a href='dicShowRequestRegistrationForm.cgi?dicLanguage=dicPortuguese'>%s</a></td>\n",
              DicGetWebUserInterfaceMessage (dicPortugueseMessage, dicLanguage));
   }
   else if (dicLanguage == dicPortuguese)
   {
      printf ("          <td align='left'><a href='dicShowRequestRegistrationForm.cgi?dicLanguage=dicEnglish'>%s</a></td>\n",
...
/*$RCSfile: dicCgiShowRequestRegistrationForm.c,v $*/
