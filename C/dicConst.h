...
/*#define DIC_COOKIE_VALUE_LENGTH*/

#define DIC_EMAIL_CHANGE_KEY_LENGTH      64
...
#define DIC_CHANGE_EMAIL_EXPIRATION_TIME     2*(24*60*60)
#define DIC_CHANGE_PASSWORD_EXPIRATION_TIME  2*(24+60*60)
/*#define DIC_COOKIE_EXPIRATION_TIME*/
